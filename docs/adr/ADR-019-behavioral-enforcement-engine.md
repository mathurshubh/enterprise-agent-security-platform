...
[ADR-017: Behavioral Detection Engine](ADR-017-behavioral-detection-engine.md) defined deterministic threat pattern analysis producing immutable **Behavioral Findings**.

[ADR-018: Behavioral Risk Engine](ADR-018-behavioral-risk-engine.md) defined cumulative risk scoring producing **Behavioral Risk Assessments** and active **Current Behavioral Risk State**.
...
- **Risk Scoring Algorithms:** Owned by [ADR-018: Behavioral Risk Engine](ADR-018-behavioral-risk-engine.md).
- **SOC Governance Dashboards:** Owned by [ADR-020: Agent Security Operations](ADR-020-agent-security-operations.md).
