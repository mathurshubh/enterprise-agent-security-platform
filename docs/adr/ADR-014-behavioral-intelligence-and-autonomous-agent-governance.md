...
- [ADR-007: Provider-Agnostic Runtime](ADR-007-provider-agnostic-runtime.md)
- [ADR-008: Enterprise Management API](ADR-008-enterprise-management-api.md)
- [ADR-009: Enterprise Security Console](ADR-009-enterprise-security-console.md)
- [ADR-010: Scenario Execution Architecture](ADR-010-scenario-execution-architecture.md)
- [ADR-011: Scenario Execution Lifecycle](ADR-011-scenario-execution-lifecycle.md)
- [ADR-012: Scenario Execution Domain Model](ADR-012-scenario-execution-domain-model.md)
